...
def process_image(msg):
    ...
    try:
        ...
        #Need to tune the threshold value randomly to find out optimizing threshold value
        ...
        pumpCircles = cv2.HoughCircles(thresh, cv2.HOUGH_GRADIENT, 1, \
            PUMP_DIAMETER, param2=7, minRadius=pumpRadiusRange[0],maxRadius=pumpRadiusRange[1])

        #check for the expected # of circle (1)
...
def start_node():
    ...
    rospy.Subscriber("IMAGE",Image,process_image)#subscribe "IMAGE" topic, monitoring messages of type Image
